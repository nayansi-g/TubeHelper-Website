    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/55 p-4">
      <div className="w-full max-w-lg rounded-2xl border border-gray-200 bg-white p-5 shadow-2xl sm:p-6">
        <div className="mb-4 flex items-start justify-between gap-4">
          <div>
            <h2 className="text-xl font-semibold text-gray-900 sm:text-2xl">Get a Free Growth Consultation</h2>
            <p className="mt-1 text-sm text-gray-600">Fill this quick form and our team will connect with you.</p>
            <p className="mt-2 text-xs text-gray-600">contact@tubehelper.in | +91 9897165137</p>
          </div>
          <button
