  ...
  return (
    <section className="relative h-[90vh] flex flex-col items-center py-20 text-center px-2 md:px-4 lg:px-6 overflow-hidden bg-[#080B1A] text-white">
      ...
      <motion.div
        ...
        className="absolute top-[-200px] left-[-200px] w-[600px] h-[600px] bg-purple-600 blur-[200px] rounded-full"
      />
      ...
      <motion.div
        ...
        className="absolute bottom-[-200px] right-[-200px] w-[600px] h-[600px] bg-pink-600 blur-[200px] rounded-full"
      />
      ...
      <div className="relative z-10 max-w-7xl">
        ...
        >
          <div className="hidden md:block h-[1px] w-[300px] opacity-30 bg-purple-500"></div>
          ...
          <motion.span
            ...
            className="px-4 py-1 flex justify-center items-center gap-1 text-sm rounded-full bg-white/10 backdrop-blur-lg border border-white/20"
          >
            <Sparkle className="w-4 text-gray-300" />
            Wordpress Solution in 1 Place
          </motion.span>
        ...
        >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center px-1 py-1 rounded-full border border-white/20 bg-white/10 backdrop-blur-md hover:bg-white/20 transition"
          >
            <motion.div
              animate={{ rotate: [0, -10, 10, 0] }}
              transition={{ repeat: Infinity, duration: 2 }}
              className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 border border-white/20 hover:bg-white/20 transition cursor-pointer"
            >
              <FaWhatsapp className="text-white text-lg" />
            </motion.div>
            <div className="px-2 text-sm cursor-pointer">Chat Now</div>
          </motion.button>
